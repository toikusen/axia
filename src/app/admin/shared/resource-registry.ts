  ...
  const registry: Record<AdminResourceKey, AdminResourceConfig> = {
    information: {
      ...
      fields: [
        ...
        },
        {
          ...
          imageHint: '橫幅，建議 1200×630px，JPG 或 PNG，10MB 以內。',
        },
        {
          key: 'tags',
          label: '標籤',
    ...
    schedule: {
      ...
      fields: [
        ...
        { key: 'ticket_url', label: '購票連結', type: 'text',
          description: '貼上完整網址（https:// 開頭），少打會自動補上，沒有可留空。' },
      ...
      fromFormValue: value => ({
        ...
        ticket_url: normalizeUrl(defaultString(value['ticket_url'])),
    ...
    member: {
      ...
      fields: [
        { key: 'name', label: '名稱', type: 'text', required: true },
        {
          ...
          type: 'image',
          uploadFolder: 'member',
          imageHint: '直式 3:4，建議 900×1200px，JPG 或 PNG，10MB 以內。',
        },
    ...
    video: {
      ...
      fields: [
        ...
        { key: 'youtube_url', label: 'YouTube 連結', type: 'text', required: true },
        {
          ...
          type: 'image',
          uploadFolder: 'video',
          imageHint: '16:9，建議 1280×720px（留空會自動用 YouTube 縮圖）。',
        },
    ...
    discography: {
      ...
      fields: [
        { key: 'title', label: '標題', type: 'text', required: true },
        {
          ...
          imageHint: '正方形，建議 1000×1000px，JPG 或 PNG，10MB 以內。',
        },
    ...
    goods: {
      ...
      fromFormValue: value => ({
        ...
        description: defaultString(value['description']) || null,
        purchase_url: normalizeUrl(defaultString(value['purchase_url'])),
